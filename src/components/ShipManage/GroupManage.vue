...
export default {
    ...
    methods:{
        ...
        queryShipTeamShipList(){
            if(this.tableRadio==''){
                ...
                axiosPost("/api/CTBT/services/Ships", "queryShipTeamShipList", args, this).then((res) => {
        ...
        queryShipTeamAlarmList(){
            if(this.tableRadio==''){
                ...
                this.teamId = this.tableRadio.TEAMID;
                let args = '{"userId":"' + localStorage.getItem("userEncryptId") + '","teamId":"' + this.teamId + '" }'
                axiosPost("/api/CTBT/services/Ships", "queryShipTeamAlarmList", args, this).then((res) => {
                    let jsonObj=JSON.parse(res);
    ...
    mounted() {
        ...
        axiosPost("/api/CTBT/services/Ships","queryShipTeamList",args,this).then((res) => {
            let jsonObj=JSON.parse(res);
